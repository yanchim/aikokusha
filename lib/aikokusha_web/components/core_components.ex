defmodule AikokushaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AikokushaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AikokushaWeb.Gettext, "errors", msg, opts)
    end
  end
